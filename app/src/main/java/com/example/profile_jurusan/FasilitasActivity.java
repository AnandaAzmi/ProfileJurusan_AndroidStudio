...
public class FasilitasActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.fasilitas_page);
        ...
        spmbIcon.setOnClickListener(v -> {
            Intent intent = new Intent(FasilitasActivity.this, SpmbActivity.class);
            startActivity(intent);
        });

        ImageView prodiIcon = findViewById(R.id.icon_program_studi);
        prodiIcon.setOnClickListener(v -> {
            Intent intent = new Intent(FasilitasActivity.this, ProgramStudiActivity.class);
            startActivity(intent);
        });

        ImageView dosentendikIcon = findViewById(R.id.icon_dosen_tendik);
        dosentendikIcon.setOnClickListener(v -> {
            Intent intent = new Intent(FasilitasActivity.this, DosenTendikActivity.class);
            startActivity(intent);
        });
